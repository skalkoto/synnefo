...
def printable_char_range(allow_ws=True, exclude=(), invert=False):
    ...
    def whitespace(char):
        """Returns True if char is a whitespace and whitespaces are not
        allowed"""
        category = unicodedata.category(char)
        return category.startswith("Z") and (allow_ws is False)
    ...
    def non_valid(char):
        ...
        result = char in exclude or non_printable(char) or whitespace(char)
